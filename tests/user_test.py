...
from src.backend.models.user import UserSave, InvalidEmailError, InvalidPasswordError
...
def test_customer_with_valid_email() -> None:
    ...
    '''
    customer = UserSave(id = 1, username = 'TempUser', email = 'tempuser@tu.com', password = 'Abc@1234', role = "Customer")
...
def test_customer_with_invalid_email() -> None:
    ...
    with pytest.raises(pydantic_core.ValidationError):
        customer = UserSave(id = 1, username = 'TempUser', email = '', password = 'Abc@1234', role = "Customer")

    with pytest.raises(InvalidEmailError):
        customer = UserSave(id = 1, username = 'TempUser', email = 'RandomString', password = 'OhYeah', role = "Customer")
...
def test_customer_with_invalid_password() -> None:
    ...
    '''
    with pytest.raises(pydantic_core.ValidationError):
        customer = UserSave(id = 1, username = 'TempUser', email = 'tempuser@tu.com', password = '', role = "Customer")

    with pytest.raises(InvalidPasswordError):
        customer = UserSave(id = 1, username = 'TempUser', email = 'tempuser@tu.com', password = '1234', role = "Customer")