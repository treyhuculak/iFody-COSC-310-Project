...
def test_client(tmp_path):
    ...
    yield client, temp_notif_db, transaction_controller
...
def test_successful_cash_transaction_notification(test_client):
    client, temp_notif_db, transaction_controller = test_client
    ...
    response = client.post("/orders/", json={
        ...
        "order_items": [{"item_id": 101, "quantity": 2, "price_at_purchase": 5.0}]
    })
    ...
    transaction_controller.create_transaction(PaymentTransactionCreate(
        payment_method_id=1,
        order_id=order_id,
        amount=1.10
    ))
...
def test_successful_card_transaction_notification(test_client):
    client, temp_notif_db, transaction_controller = test_client
...
def test_unsuccessful_card_transaction_notification(test_client):
    client, temp_notif_db, transaction_controller = test_client
